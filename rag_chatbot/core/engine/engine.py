...
from ..prompt import get_context_prompt, get_condensed_context_prompt
...
class LocalChatEngine:
    ...
    def set_engine(
        ...
        return CondensePlusContextChatEngine.from_defaults(
            ...
            context_prompt=get_context_prompt(language),
            condense_prompt=get_condensed_context_prompt(language),
        )
